...
const User = ({ item }) => {
  ...
  //     try {
  //       const response = await fetch(
  //         `http://192.168.1.6:8000/api/user/friend-requests/sent/${userId}`
  //       );
  ...
  //     try {
  //       const response = await fetch(`http://192.168.1.6:8000/api/user/friends/${userId}`);
  ...
  //   try {
  //     const response = await fetch("http://192.168.1.6:8000/api/user/friend-request", {
  //       method: "POST",
  //       headers: {
  //         "Content-Type": "application/json",
  //       },
